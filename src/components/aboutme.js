        ...
        <div className="flex flex-col md:flex-row items-center my-10 md:gap-[80px]">
            <div className="flex items-center w-full md:w-1/2 m-auto">
                <div className="flex w-[360px] h-[380px] md:w-[440px] md:h-[520px] m-auto justify-center relative">
                    <img className="w-[280px] h-[360px] md:w-[400px] md:h-[480px] z-10 absolute md:top-0 md:left-[40px]" style={
                        {border: `8px solid ${props.pagemode > 0 ? "black":"white"}`, zIndex:"1"}
                    } src="/profile-picture.jpeg"/>
                    <div className="w-[320px] h-[360px] md:w-[400px] md:h-[480px] bg-slate-200 absolute top-6 md:top-[40px] md:left-0" style={{border: `8px solid ${props.pagemode > 0 ? "black":"white"}`, backgroundColor:`${props.pagemode > 0 ? "#374151" : "#E5E7EB"}`}}>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-5 w-full md:w-1/2 text-[16px] text-justify">
                ...
                <p>I'm a passionate, <span className="underline underline-offset-4 ...">self-proclaimed designer</span> who specialized in full stack development (React.js & Node.js). I'm very enthusiastic about bringing the technical and visual aspects of digital product to life. User experience, pixel perfect design, and writing clear, readable, highly performant code matters to me.</p>
                ...
                <p>When i'm not in full-on developer mode, you can find me hovering around on twitter or on indie hacker, witnessing the journey of early startups or enjoying some free time. You can follow me on Twitter where i share tech-related bites and build in public, or you can follow me on <span className="underline underline-offset-4">Github</span>.</p>
