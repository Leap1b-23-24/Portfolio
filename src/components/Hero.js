export const Hero = (props) => {
    return (
        <div className=" bg-white flex flex-col sm:px-20 dark:bg-black dark:text-white ">
            <div className="flex flex-col-reverse py-16 px-4   sm:flex-row  sm:py-24 gap-12 sm:justify-between ">
                <div className=" flex flex-col grow gap-12 ">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-6xl font-bold">{props.name}</h1>
                        <p className="text-base font-normal text-gray-600 dark:text-[#D1D5DB] ">{props.about}</p>
                    </div>
                    <div className="flex flex-col text-base font-normal text-gray-600 dark:text-[#D1D5DB] gap-2">
                ...
                <div className="flex justify-center sm:w-[400px] sm:pr-20">
                    <div className="relative w-[280px] h-[320px] sm:mr-[40px]">
                        <div className=" absolute bg-gray-200 top-5 w-full h-full top-[20px] left-[0px] sm:top-[40px] sm:left-[40px]"></div>
                        <div className="relative border-solid  border-3 w-[calc(100%-40px)] left-[20px] sm:left-[0px] sm:w-full h-full ">
                            <img className="w-full h-full object-cover" src="/Pic.png" />
                        </div>
                    </div>
                </div>
            </div>
